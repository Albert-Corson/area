...
namespace Area.API.Migrations
{
    ...
    [Migration("20210301231611_AddParamEnumType")]
    partial class AddParamEnumType
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Area.API.Models.Table.EnumModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Area.API.Models.Table.ManyToMany.ParamEnumModel", b =>
                {
                    ...
                    b.HasKey("ParamId", "EnumId");

                    b.HasIndex("EnumId");

                    b.ToTable("ParamsToEnums");
                });
            ...
            modelBuilder.Entity("Area.API.Models.Table.EnumModel", b =>
                {
                    b.OwnsMany("Area.API.Models.Table.Owned.EnumValueModel", "Values", b1 =>
                        {
                            b1.Property<int>("EnumModelId")
                                .HasColumnType("integer");
                            ...
                            b1.HasKey("EnumModelId", "Id");

                            b1.ToTable("EnumHasValues");

                            b1.WithOwner()
                                .HasForeignKey("EnumModelId");
                        });
            ...
            modelBuilder.Entity("Area.API.Models.Table.ManyToMany.ParamEnumModel", b =>
                {
                    b.HasOne("Area.API.Models.Table.EnumModel", "Enum")
                        .WithMany()
                        .HasForeignKey("EnumId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Area.API.Models.Table.ParamModel", "Param")
                        .WithMany("Enums")
