...
create table "WidgetHasDefaultParams"
(
    "WidgetModelId" integer not null
        constraint "FK_WidgetHasDefaultParams_Widgets_WidgetModelId"
            references "Widgets"
            on delete cascade,
    "Id"            integer generated by default as identity,
    "Name"          text,
    "Type"          text,
    "Value"         text,
    constraint "PK_WidgetHasDefaultParams"
        primary key ("WidgetModelId", "Id")
);

alter table "WidgetHasDefaultParams"
    owner to postgres;
