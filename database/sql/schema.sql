...
create table "EnumHasValues"
(
    "EnumModelId" integer not null
        constraint "FK_EnumHasValues_Enums_EnumModelId"
            references "Enums"
                on delete cascade,
    "Id" integer generated by default as identity,
    "Value" text not null,
    "DisplayName" text not null,
    constraint "PK_EnumHasValues"
        primary key ("EnumModelId", "Id")
);

alter table "EnumHasValues" owner to postgres;

create table "ParamsToEnums"
(
    "ParamId" integer not null
        constraint "FK_ParamsToEnums_Params_ParamId"
            references "Params"
                on delete cascade,
    "EnumId" integer not null
        constraint "FK_ParamsToEnums_Enums_EnumId"
            references "Enums"
                on delete cascade,
    constraint "PK_ParamsToEnums"
        primary key ("ParamId", "EnumId")
);

alter table "ParamsToEnums" owner to postgres;

create index "IX_ParamsToEnums_EnumId"
    on "ParamsToEnums" ("EnumId");
